...
const CompanyLogin = () => {
  ...
  const loginSubmit = async (formdata, { resetForm, setSubmitting }) => {
    ...
    const res = await fetch('http://localhost:5000/company/authenticate', {
      method: 'POST',
  ...
  return (
    <div className="login-bg-image vh-100 container-fluid">
          ...
          <div className="card mx-auto">
            <div className="card-body">
              ...
              <p className="text-center mt-2">
                Don't have account? <Link to="/main/signup">SignIn</Link>
              </p>
            </div>
          </div>
        </div>
